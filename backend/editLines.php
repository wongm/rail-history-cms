...
<tr valign="top" height="20"><td align="left" colspan=2><hr>Display</td></tr>
	...
	<tr valign="top" height="20">
		...
		<td>
<? drawLocationTabDisplayFields($thisTodisplay, $thisLink); ?>
		</td>
	</tr>
...
<tr valign="top" height="20"><td align="left" colspan=2><hr>Track diagrams</td></tr>
	<tr valign="top" height="20">
		...
		<td> 
		<textarea name="thisTrackDiagramNoteField" wrap="VIRTUAL" cols="100" rows="4"><? echo $thisTrackDiagramNote; ?></textarea>
		</td> 
	</tr>
	<tr valign="top" height="20">
	...
	<tr valign="top" height="20">
		...
		<td> <input type="text" name="thisTrackyearsField" size="100" value="<? echo $thisTrackyears; ?>">  </td> 
	</tr>
	<tr valign="top" height="20">
		<td align="right"> <b> <abbr title="'9999' to default to now, '0' to show all">(Default)</abbr> :   </b> </td>
		<td> <input type="text" name="thisTrackdefaultField" size="100" value="<? echo $thisTrackdefault; ?>">  </td> 
	</tr>
	<tr valign="top" height="20">
		<td align="right"> <b> <abbr title="Use a dash to separate bounds, and a semicolon to seprate pages">Track subpages</abbr> :   </b> </td>
		<td> <input type="text" name="thisTracksubpageField" size="100" value="<? echo $thisTracksubpage; ?>">  </td> 
	</tr>
	<tr valign="top" height="20">
	...
	<tr valign="top" height="20">
		...
		<td> <input type="text" name="thisDiagramTabsField" size="100" value="<? echo $thisDiagramtabs; ?>"> <br>
		<small>CSV's years for a separate diagrams subpage. (Images need to be titled '/t/<?=$thisLink; ?>-[YEAR].gif') </small></td> 
	</tr>
...
<tr valign="top" height="20"><td align="left" colspan=2><hr>Safeworking diagrams</td></tr>
	<tr valign="top" height="20">
		...
		<td> 
		<textarea name="thisSafeworkingDiagramNoteField" wrap="VIRTUAL" cols="100" rows="4"><? echo $thisSafeworkingDiagramNote; ?></textarea>
		</td> 
	</tr>
	<tr valign="top" height="20">
		<td align="right"> <b> <abbr title="CSVs - years to show in lineguide safeworking diagram">Safeworking years</abbr> :  </b> </td>
		<td> <input type="text" name="thisSafeworkingyearsField" size="100" value="<? echo $thisSafeworkingyears; ?>">  </td> 
	</tr>
	<tr valign="top" height="20">
		<td align="right"> <b> <abbr title="'9999' to default to now, '0' to show all">(Default)</abbr> :   </b> </td>
		<td> <input type="text" name="thisSafeworkingdefaultField" size="100" value="<? echo $thisSafeworkingdefault; ?>">  </td> 
	</tr>
...
<tr valign="top" height="20"><td align="left" colspan=2><hr>Front page</td></tr>		
	...
	<tr valign="top" height="20">
		...
		<td> <input type="text" name="thisPhotosField" size="100" value="<? echo $thisPhotos; ?>">  <br>
	...
	<tr valign="top" height="20">
		...
		<td> <textarea name="thisCreditsField" wrap="VIRTUAL" cols="100" rows="8"><? echo $thisCredits; ?></textarea></td> 
	</tr>
</table>
...
<? drawObjectSources('railline', $thisLineId); ?>
